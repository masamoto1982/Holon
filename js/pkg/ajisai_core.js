...
const AjisaiInterpreterFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_ajisaiinterpreter_free(ptr >>> 0, 1));
...
export class AjisaiInterpreter {
    ...
    init_step(code) {
        ...
        try {
            const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.ajisaiinterpreter_init_step(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    step() {
        const ret = wasm.ajisaiinterpreter_step(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_register() {
        const ret = wasm.ajisaiinterpreter_get_register(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {string[]}
     */
    get_custom_words() {
        const ret = wasm.ajisaiinterpreter_get_custom_words(this.__wbg_ptr);
